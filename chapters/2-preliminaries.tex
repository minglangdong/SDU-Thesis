...
\subsection{Batch Oblivious Programmable Pseudorandom Function}\label{sec:bopprf}
...
\end{minipage}
\end{framed}
\caption{秘密分享隐私相等性测试的理想功能 $\FuncssPEQT$}\label{fig:func-sspeqt}
\end{figure}
...
MKR-PKE 是一个满足选择明文攻击下不可区分性（indistinguishability under chosen-plaintext attack, IND-CPA）的安全性定义的 PKE 方案，并具备以下额外性质：
